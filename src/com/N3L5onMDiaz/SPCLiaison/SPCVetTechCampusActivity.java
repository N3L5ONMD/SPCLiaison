        ...
        LocationSource
{
    ...
    LatLng VET_TECH_CENTER = new LatLng(27.885924, -82.811087);
    ...
    private void setUpMap()
    {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(VET_TECH_CENTER, 10));
        mMap.addMarker(new MarkerOptions().position(VET_TECH_CENTER).title("Veterinary Technology Center").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
