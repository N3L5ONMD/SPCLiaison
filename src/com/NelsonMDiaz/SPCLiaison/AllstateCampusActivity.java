        ...
        LocationSource
{
    ...
    LatLng ADMINISTRATION_ALLSTATE = new LatLng(27.738891, -82.678470);
    ...
    private void setUpMap()
    {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(ADMINISTRATION_ALLSTATE, 10));
        mMap.addMarker(new MarkerOptions().position(ADMINISTRATION_ALLSTATE).title("AD").snippet("Administration").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
