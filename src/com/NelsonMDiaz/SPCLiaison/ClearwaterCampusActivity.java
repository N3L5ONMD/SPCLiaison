 ...
 */
public class ClearwaterCampusActivity extends FragmentActivity
        ...
        LocationSource
{
    ...
    LatLng ADMINISTRATION_CLEARWATERCAMPUS = new LatLng(27.966818, -82.734839);
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.clearwater_campus);
    ...
    public void onClick(DialogInterface dialog, int which)
    {
        switch (which)
        {
            case DialogInterface.BUTTON_POSITIVE:
                ...
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://maps.google.com/maps?saddr=&daddr=27.966818, -82.734839"));
    ...
    private void setUpMap()
    {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(ADMINISTRATION_CLEARWATERCAMPUS, 10));
        mMap.addMarker(new MarkerOptions().position(ADMINISTRATION_CLEARWATERCAMPUS).title("AD").snippet("Administration").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
