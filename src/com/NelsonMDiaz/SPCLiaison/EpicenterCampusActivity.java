        ...
        LocationSource
{
    ...
    LatLng ADMINISTRATION_EPICENTER = new LatLng(27.897677, -82.711946);
    ...
    private void setUpMap()
    {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(ADMINISTRATION_EPICENTER, 10));
        mMap.addMarker(new MarkerOptions().position(ADMINISTRATION_EPICENTER).title("AD").snippet("Administration").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
