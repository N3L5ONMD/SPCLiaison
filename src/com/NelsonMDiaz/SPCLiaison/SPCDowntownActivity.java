...
public class SPCDowntownActivity extends FragmentActivity implements
        ...
        LocationSource
{
    ...
    LatLng MAIN_ENTRANCE_DOWNTOWN = new LatLng(27.773361, -82.636500);
    ...
    private void setUpMap()
    {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(MAIN_ENTRANCE_DOWNTOWN, 10));
        mMap.addMarker(new MarkerOptions().position(MAIN_ENTRANCE_DOWNTOWN).title("Main Entrance").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
