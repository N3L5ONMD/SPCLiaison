...
public class SPCMidtownActivity extends FragmentActivity
        ...
        LocationSource
{
    ...
    LatLng MAIN_ENTRANCE_MIDTOWN = new LatLng(27.759863, -82.662706);
    ...
    private void setUpMap()
    {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(MAIN_ENTRANCE_MIDTOWN, 10));
        mMap.addMarker(new MarkerOptions().position(MAIN_ENTRANCE_MIDTOWN).title("Main Entrance").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
