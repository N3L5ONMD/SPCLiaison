...
public class TarponSpringsCampusActivity extends FragmentActivity
        ...
        LocationSource
{
    ...
    LatLng ADMINISTRATION_TARPON = new LatLng(28.122821, -82.743386);
    ...
    private void setUpMap()
    {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(ADMINISTRATION_TARPON, 10));
        mMap.addMarker(new MarkerOptions().position(ADMINISTRATION_TARPON).title("AD").snippet("Administration").icon(BitmapDescriptorFactory.fromResource(R.drawable.pin)));
